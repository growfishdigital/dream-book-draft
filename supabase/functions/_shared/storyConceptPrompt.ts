...
export function STORY_CONCEPT_USER_TEMPLATE(ctx: StoryConceptPromptCtx): string {
  ...
  return [
    ...
    ctx.personalityLine ? `Personality traits: ${ctx.personalityLine}` : "",
    ...
    `- full_book_instruction: 2–4 sentences telling the later full-book engine how to expand this concept into a 30-page picture book, including tone, pacing, and emotional direction.`,
    ``,
    `# Quality bar`,
    ...
    `Avoid these words in the title and user-visible summary unless the user specifically provided them: magical, adventure, wonderful, journey, special.`,
