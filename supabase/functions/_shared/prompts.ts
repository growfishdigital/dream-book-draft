...
export const ART_STYLE_PROMPTS: Record<string, string> = {
  ...
  "hand-drawn-charm":
    "soft hand-drawn children's book illustration that reads primarily as gentle hand-painted artwork with only subtle hints of colored pencil and graphite, forms defined mainly by clean softly painted color fills rather than by heavy linework, very light and sparing pencil outlines used only as delicate accents on key edges, small amounts of fine pencil shading and crayon texture sprinkled tastefully on hair, clothing folds, and background flourishes (small swirls, stars, drifting strokes) — never covering whole shapes, clean warm cream paper ground, clear and confident color palette with real saturation (bright sunny yellows, soft true reds, fresh leaf greens, clean sky blues, warm honey browns) — sharper and cleaner than pastel, never washed-out, dusty, sepia, or overly earthy, cozy whimsical innocent nostalgic mood; characters have soft rounded proportions, large dot eyes with tiny highlights, simple curved smiles, very small understated rosy cheek circles that blend softly into the skin, and softly painted hair with just a few visible pencil strokes for texture; no 3D render, no photorealism, no sharp vector graphics, no digital airbrushing, no heavy ink outlines, no all-over scratchy sketch lines, no full colored-pencil shading covering every surface, no muddy or washed-out colors, no glossy finish",
