...
export const ART_STYLE_PROMPTS: Record<string, string> = {
  ...
  "hand-drawn-charm":
    "hand-drawn children's book illustration that looks genuinely made by hand with real ink pen and colored pencils on warm cream paper; line work is done with a fine ink pen and has the natural character of a human hand — slightly uneven thickness, gently wobbly contours, the occasional doubled or broken stroke, soft tapered ends — never perfectly smooth, never mechanical, never vector-clean, never marker-thick; lines are dark brown/sepia ink, clearly visible but thin and delicate; color is applied with visible colored-pencil strokes — directional hatching, gentle layered shading, small areas of white paper showing through inside fills, a touch of crayon-like grain — sitting inside (not always perfectly aligned with) the ink outlines; clean warm cream paper ground with a PLAIN, UNCLUTTERED background — absolutely NO decorative background icons, NO little doodles, swirls, stars, sparkles, hearts, or scattered motifs behind the characters; rich, grounded color palette with real depth (warm golden yellows, true tomato reds, deep leaf and sage greens, honest sky and denim blues, warm honey and walnut browns) — anchored and substantial, NEVER pastel, washed-out, dusty, sepia-toned, or overly light/airy; cozy whimsical innocent nostalgic mood; characters have soft rounded proportions, large dot eyes with tiny highlights, simple curved smiles, very small understated rosy cheek circles that blend softly into the skin, and softly pencil-shaded hair; no 3D render, no photorealism, no vector graphics, no digital airbrushing, no perfectly uniform outlines, no glossy finish, no background doodles or decorative icons",
